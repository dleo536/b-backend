...
export class BaselineSchema1774841513798 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."reviews_visibility_enum" AS ENUM('public', 'friends', 'private')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "idx_review_visibility" ON "reviews" ("visibility") `,
    );
    await queryRunner.query(
      `CREATE INDEX "idx_review_album_lookup" ON "reviews" ("releaseGroupMbId") `,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_2dc6d909e0514b7046915f80d3" ON "reviews" ("userId", "releaseGroupMbId") WHERE "isDraft" = false`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."user_authprovider_enum" AS ENUM('local', 'google', 'apple', 'github', 'spotify')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."user_profilevisibility_enum" AS ENUM('public', 'friends', 'private')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."user_roles_enum" AS ENUM('user', 'mod', 'admin')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_d1c82fcf193e9c2eb76e6d0ffe" ON "user" ("oauthId") WHERE "oauthId" IS NOT NULL`,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_a27b942a0d6dcff90e3ee9b5e8" ON "user" ("usernameLower") `,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_562834ea51a3ecb0475831f860" ON "user" ("emailLower") `,
    );
    await queryRunner.query(
      `CREATE TABLE "user_follows" ("followerId" uuid NOT NULL, "followingId" uuid NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_48050dfc1d2514f4c2059f155eb" PRIMARY KEY ("followerId", "followingId"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "user_follows" ADD CONSTRAINT "FK_6300484b604263eaae8a6aab88d" FOREIGN KEY ("followerId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "user_follows" ADD CONSTRAINT "FK_7c6c27f12c4e972eab4b3aaccbf" FOREIGN KEY ("followingId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "album_lists" ADD CONSTRAINT "FK_716ffb90504bd1a8178808a28ff" FOREIGN KEY ("ownerId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "list_likes" ADD CONSTRAINT "FK_5d24261158e03bee956bb474a34" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "list_likes" ADD CONSTRAINT "FK_24093bbcc1f5efa9690f7886a63" FOREIGN KEY ("listId") REFERENCES "album_lists"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "list_likes" DROP CONSTRAINT "FK_24093bbcc1f5efa9690f7886a63"`,
    );
    await queryRunner.query(
      `ALTER TABLE "list_likes" DROP CONSTRAINT "FK_5d24261158e03bee956bb474a34"`,
    );
    await queryRunner.query(
      `ALTER TABLE "album_lists" DROP CONSTRAINT "FK_716ffb90504bd1a8178808a28ff"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_3bff39f50af4abc7f23b675690"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_dfc5fc6e2f00c857816ff3dd02"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_00a4a4de19131f9cd83ac0e4b9"`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_562834ea51a3ecb0475831f860"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_a27b942a0d6dcff90e3ee9b5e8"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_d1c82fcf193e9c2eb76e6d0ffe"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_2dc6d909e0514b7046915f80d3"`,
    );
